...
- [attune-ai](https://github.com/Smart-AI-Memory/attune-ai), a Python MCP server providing developer workflow tools — security audits, code reviews, test generation, and release preparation with cost-optimized Claude model routing.
